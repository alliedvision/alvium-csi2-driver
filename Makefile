...
overlay_install:
	...
	install -m 0644 $(SRC)/overlay/tegra234-p3767-camera-p3768-alvium-dual-19623+19502-1x2-1x4.dtbo $(INSTALL_MOD_PATH)/boot/
	install -m 0644 $(SRC)/overlay/tegra234-p3767-camera-p3768-alvium-dual-19623+19558-1x2-1x4.dtbo $(INSTALL_MOD_PATH)/boot/
