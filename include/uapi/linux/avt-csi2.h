...
#define AVT_CID_SENSOR_ID				(AVT_CID_CAMERA_BASE + 41)
#define AVT_CID_SENSOR_PLATFORM_ID			(AVT_CID_CAMERA_BASE + 42)
#define AVT_CID_SENSOR_FLAGS				(AVT_CID_CAMERA_BASE + 43)
#define AVT_SENSOR_FLAG_MONO				BIT(0)					
#define AVT_SENSOR_FLAG_POLARIZER			BIT(1)
