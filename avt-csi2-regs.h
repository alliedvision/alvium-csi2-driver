...
#define BCRM_VERSION_MAJOR					GENMASK(31, 16)
#define BCRM_VERSION_MINOR					GENMASK(15, 0)
...
#define BCRM_FEATURE_INQ_MAINBOARD_TEMPERATURE_WARNING		BIT(29)
#define BCRM_FEATURE_INQ_EXPOSURE_AND_GAIN_COMINED		BIT(30)
#define BCRM_FEATURE_INQ_DPC_ENABLE				BIT(31)
#define BCRM_FEATURE_INQ_SENSORBOARD_TEMPERATURE_WARNING	BIT(32)
#define BCRM_FEATURE_INQ_SENSOR_IDENTIFICATION			BIT(33)
...
#define BCRM_DEVICE_STATUS_SENSOR_COMMUNINICATION_OKAY	BIT(5)
...
#define BCRM_EXPOSURE_TIME_GAIN_COMBINED_64RW		0x0224

#define BCRM_INTENSITY_CONTROLLER_REGION_8RW		0x022C
...
#define BCRM_MAINBOARD_TEMPERATURE_WARNING_LEVEL_32RW	0x0394
#define BCRM_SENSORBOARD_TEMPERATURE_WARNING_LEVEL_32RW	0x0398

#define BCRM_SENSOR_IDENTIFICATION_32R			0x039c
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_ID		GENMASK(7, 0)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_PLATFORM_ID	GENMASK(15, 8)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_INFO		GENMASK(23, 16)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_IS_MONO	BIT(16)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_IS_POLARIZER	BIT(17)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_DETECT_OK	BIT(30)
#define BCRM_SENSOR_IDENTIFICATION_SENSOR_FITS_FIRMWARE	BIT(31)
...
#define CCI_REGISTER_LAYOUT_VERSION_32R			0x0000
#define CCI_REGISTER_LAYOUT_VERSION_MINOR		GENMASK(15, 0)
#define CCI_REGISTER_LAYOUT_VERSION_MAJOR		GENMASK(31, 16)

#define CCI_SOFTRESET_8W				0x021E		
