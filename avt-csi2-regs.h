...
#define BCRM_DEVICE_STATUS_TEMPERATURE_OKAY		BIT(1)
...
#define BCRM_COLOR_MATRIX_BASE_32RW			0x02E8
//#define BCRM_COLOR_TRANSFORM_MATRIX_INDEX_8RW		0x02E8
//#define BCRM_COLOR_TRANSFORM_MATRIX_VALUE_32RW		0x02EC
